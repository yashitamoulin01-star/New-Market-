          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {result.total > 0 ? (
              <T
                ...
                hi={`नई मार्केट में ${result.total} संपत्तियाँ`}
              />
            ) : (
              <T en="Commercial spaces in New Market, Bhopal" hi="नई मार्केट में व्यावसायिक स्थान" />
            )}
          </p>
        </div>
        <Link
        ...
        <div className="rounded-xl border border-dashed bg-card py-16 text-center">
          ...
          <p className="mb-4 text-sm text-muted-foreground">
            {propertyType || listingType ? (
              ...
              <T en="Be the first to list a commercial space in New Market." hi="नई मार्केट में पहली संपत्ति लिस्ट करें।" />
            )}
          </p>
          <Link
            href="/property/list"
